...
//    //defined poses on the field to use
    ...
    public Pose2d MiddleBoardPose = new Pose2d(100,15,Math.toRadians(180));
    public Pose2d RightBoardPose = new Pose2d(100, 10,Math.toRadians(180));
//
//
//
...
//
    public void runOpMode() throws InterruptedException {
        ...
        Action LeftSpikeScore = bot.actionBuilder(bot.pose)
                //get to left spike
...
//                .afterTime(8, () -> intake.wrist_up())
        ...
        Action MiddleSpikeScore = bot.actionBuilder(bot.pose)
                //get to middle spike
                //.afterTime(0, () -> intake.openClaws(false))
...
//                .afterTime(8, () -> intake.wrist_up())
        ...
        Action RightSpikeScore = bot.actionBuilder(bot.pose)
                //get to right spike
                .lineToYLinearHeading(poseY(20),poseHeading(-90))
                .waitSeconds(.1)
...
//                .afterTime(8, () -> intake.wrist_up())
        ...
        Action PreloadScore1 = bot.actionBuilder(bot.pose)
                //get to backboard
        ...
        Action PreloadScore2 = bot.actionBuilder(bot.pose)
                //get to backboard
        ...
        Action PreloadScore3 = bot.actionBuilder(bot.pose)
                //get to backboard
        ...
        Action CheckPoint1 = bot.actionBuilder(bot.pose)
                .splineToConstantHeading(checkPoint1, poseHeading(0))
                .build();

        Action CheckPoint2 = bot.actionBuilder(bot.pose)
        ...
        Action get2StackedPixels = bot.actionBuilder(bot.pose)//TODO
                .build();

        Action ScorePixels = bot.actionBuilder(bot.pose) //TODO
                .build();


        Action Park = bot.actionBuilder(bot.pose) //TODO
                .build();
