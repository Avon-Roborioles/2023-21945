...
public class Pixel_Stack_Processor implements VisionProcessor {
     ...
     */
    public Pixel_Stack_Processor(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
